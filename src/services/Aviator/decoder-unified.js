  ...
  try {
    ...
    switch (actualDecoderType) {
      case DECODER_TYPES.MSGPACK:
        ...
        // Si MessagePack falla, intentar SFS como fallback
        console.log('[UnifiedDecoder] MessagePack falló, intentando SFS como fallback...');
      ...
      default:
        ...
        // Si SFS falla, intentar MessagePack como fallback
        console.log('[UnifiedDecoder] SFS falló, intentando MessagePack como fallback...');
